...
DEBUG = True
ALLOWED_HOSTS = [
    'charlesetta-petticoatless-unvolcanically.ngrok-free.dev',
    '127.0.0.1',
    'localhost',
]
# Le dice a Django que confíe en esta URL para peticiones segura
CSRF_TRUSTED_ORIGINS = [
    'https://charlesetta-petticoatless-unvolcanically.ngrok-free.dev'
]
